...
const Hello = ({ children }) => {
  ...
  return (
    <>
      ...
      <Message className='animation-fade-in px-6 font-normal text-white opacity-0 !animation-delay-[3s] before:-bottom-px before:-left-2 before:block before:size-6 before:rounded-br-3xl before:bg-[#30db5b] after:-bottom-px after:-left-3 after:h-6 after:w-3 after:rounded-br-2xl after:bg-white dark:after:bg-surface-1'>
        {text}
      </Message>
    </>
  )
